...
const PricingCard = ({ plan, isAnnual = true }: PricingCardProps) => {
  ...
  return (
    ...
    >
      {isPopular && (
        <Badge
          style={{ background: "#365B99", color: '#fff' }}
      ...
      <CardHeader className="pb-8 pt-6">
        <div className="text-center space-y-1">
          ...
          <div className="font-display">
            <span style={{ color: hexDict[plan.color as keyof typeof hexDict] }} className="text-4xl font-bold">{plan.price}</span>
      ...
      <CardFooter className="pt-4 pb-6">
        <Button
          asChild
          style={{ background: hexDict[plan.color as keyof typeof hexDict], color: '#fff' }}
