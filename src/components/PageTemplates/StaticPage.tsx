...
function buildDefaultContent(pageName: string, opts: { businessName: string; email: string }): string {
  ...
  if (pageName === "privacy") {
    return `
      ...
      <h2>Your Rights</h2>
      <p>Depending on your location, you may have the right to access, correct, delete, or export your personal data. You may also opt out of marketing communications at any time. To exercise these rights, ${contactLine}.</p>
      ...
      <h2>Contact Us</h2>
      <p>If you have questions about this Privacy Policy or how your information is handled, ${contactLine}.</p>
    `;
  }
  ...
  if (pageName === "terms") {
    return `
      <p><strong>Effective Date:</strong> ${year}</p>
      <p>Welcome to ${businessName}. By accessing or using this website, you agree to be bound by these Terms of Service. If you do not agree, please do not use the site.</p>
      ...
      <p>To the fullest extent permitted by law, ${businessName} shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the site, including but not limited to loss of data, revenue, or profits.</p>
      <h2>Governing Law</h2>
      <p>These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which ${businessName} operates, without regard to conflict of law principles.</p>
      ...
      <h2>Contact Us</h2>
      <p>If you have questions about these Terms, ${contactLine}.</p>
    `;
  }
