...
export const metadata = {
  title: "Terms of Service | Vivreal",
  description:
    "Review Vivreal's terms of service for details on website usage, user responsibilities, legal agreements, and your rights when using our headless CMS platform.",
  alternates: {
    canonical: "https://www.vivreal.io/terms",
  },
  openGraph: {
    title: "Terms of Service | Vivreal",
    description:
      "Review Vivreal's terms of service for details on website usage, user responsibilities, legal agreements, and your rights when using our headless CMS platform.",
    url: "https://www.vivreal.io/terms",
    images: [
      {
        url: "https://www.vivreal.io/vrlogo.png",
        width: 1200,
        height: 630,
        alt: "Terms of Service | Vivreal",
      },
    ],
    type: "website",
  },
...
const TermsOfUse = () => {
  ...
  return (
    <>
      <Head>
        <title>Vivreal Terms of Service | Website Usage & Legal Terms</title>
        <meta name="description" content="Review Vivreal's terms of service for details on website usage, user responsibilities, legal agreements, and your rights when using our headless CMS platform." />
        <link rel="canonical" href={'https://www.vivreal.io/terms'} />
      </Head>
      ...
      <main className="pt-24 pb-20">
        <section className="pt-10 pb-16">
          <div className="content-grid">
              <h1 className="text-4xl md:text-5xl font-display font-bold tracking-tight mb-4">Website Terms of Use</h1>
              <p className="text-gray-800 mb-2">Version 1.0</p>
              <p className="text-gray-800 mb-2">
                  The Vivreal website located at https://www.vivreal.io is a work belonging to Hill Bomb Creations LLC. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.
              </p>
              <p className="text-gray-800 mb-2">All such additional terms, guidelines, and rules are incorporated by reference into these Terms.</p>
              <p className="text-gray-800 mb-2">
              ...
              <h2 className="text-2xl md:text-3xl font-display font-bold tracking-tight mb-6 text-center mt-6">Access to the Site</h2>
              <p className="text-gray-800 mb-2">
              ...
              <h2 className="text-2xl md:text-3xl font-display font-bold tracking-tight mb-6 text-center mt-6">Third-Party Links & Ads; Other Users</h2>
              <p className="text-gray-800 mb-2">
              ...
              <p className="text-gray-800 mb-2">
                  <strong>Cookies and Web Beacons.</strong> Like any other website, Vivreal uses &apos;cookies&apos;. These cookies are used to store information including visitors&apos; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&apos; experience by customizing our web page content based on visitors&apos; browser type and/or other information.
              </p>
              <p className="text-gray-800 mb-2">
              ...
              <h2 className="text-2xl md:text-3xl font-display font-bold tracking-tight mb-6 text-center mt-6">Disclaimers</h2>
              <p className="text-gray-800 mb-2">
              ...
              <h2 className="text-2xl md:text-3xl font-display font-bold tracking-tight mb-6 text-center mt-6">Limitation on Liability</h2>
              <p className="text-gray-800 mb-2">
              ...
              <h2 className="text-2xl md:text-3xl font-display font-bold tracking-tight mb-6 text-center mt-6">General</h2>
              <p className="text-gray-800 mb-2">
              ...
              <p className="text-gray-800 mb-2">
                  <strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief. A Notice to the Company should be sent to: 3101 N. Central Ave, Ste 183 #4297, Phoenix, Arizona 85012 Us. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally. If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding. The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.
              </p>
              <p className="text-gray-800 mb-2">
              ...
              <h2 className="text-2xl md:text-3xl font-display font-bold tracking-tight mb-6 text-center mt-6">Contact Information</h2>
              <p className="text-gray-800 mb-2">Email: hello@vivreal.io</p>
          </div>
        </section>
        
        <CTASection page="Terms"/>
      </main>
