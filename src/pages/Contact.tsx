        ...
        <section className="max-w-7xl mx-5 md:mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
          <div className="space-y-10">
            <div>
              ...
              <p className="text-md md:text-lg text-gray-800 max-w-md">
                ...
                <>
                  {roles.map(({ id, title, icon: Icon, points }) => (
                    <div key={id} className="space-y-3">
                      ...
                      <ul className="list-disc list-inside text-gray-800 space-y-1 max-w-xl">
                        {points.map((point, i) => (
          ...
          <div className="p-8 rounded-xl bg-white dark:bg-gray-900 shadow-lg animate-fade-in max-w-md w-full mx-auto">
            {success && (
