...
export default function TeamPage({
  ...
  const siteName =
    ...
    (siteData as unknown as Record<string, string>)?.name ??
    'our team';
    ...
    <main className="pt-24 md:pt-32">
      <section className="mx-auto max-w-7xl px-6 mt-14">
        ...
        <p
          ...
          style={{ color: (siteData as unknown as Record<string, string>)?.['text-primary'] }}
        >
          {labels.subtitle}
        </p>
            ...
            {members.map((member, idx) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* CMS rich-text description — sanitized server-side by VR_CMS_API before storage */}
                  <div
      ...
      <section className="mt-24 mx-auto max-w-4xl text-center px-6">
        <div className="space-y-6 bg-secondary/50 px-6 py-12 rounded-xl">
          ...
          <p
            ...
            style={{
              color: (siteData as unknown as Record<string, string>)?.['text-secondary'],
            }}
          >
