...
/* ------------------------------------------------------------------ */
function Skeleton() {
    return (_jsxs("div", { className: "relative pl-8 sm:pl-0", children: [_jsx("div", { className: "absolute left-3 sm:left-1/2 top-0 bottom-0 w-px bg-black/[0.08]" }), _jsx("div", { className: "space-y-10", children: [...Array(4)].map((_, i) => (_jsxs("div", { className: "relative sm:grid sm:grid-cols-2 sm:gap-8", children: [_jsx("div", { className: "absolute left-3 sm:left-1/2 top-4 -translate-x-1/2 h-3 w-3 rounded-full bg-black/[0.08] ring-4 ring-white" }), _jsx("div", { className: `animate-pulse ${i % 2 === 0 ? "sm:pr-8" : "sm:col-start-2 sm:pl-8"}`, children: _jsxs("div", { className: "rounded-2xl border border-black/[0.06] bg-white p-5", children: [_jsx("div", { className: "h-4 w-20 rounded-full bg-black/[0.06] mb-3" }), _jsx("div", { className: "h-5 w-3/4 rounded-lg bg-black/[0.06]" }), _jsxs("div", { className: "mt-3 space-y-1.5", children: [_jsx("div", { className: "h-4 w-full rounded-lg bg-black/[0.04]" }), _jsx("div", { className: "h-4 w-2/3 rounded-lg bg-black/[0.04]" })] })] }) })] }, i))) })] }));
}
/* ------------------------------------------------------------------ */
/*  Empty state                                                        */
/* ------------------------------------------------------------------ */
function Empty({ message }) {
    return (_jsxs("div", { className: "rounded-2xl border border-black/[0.06] bg-white p-12 text-center", children: [_jsx("div", { className: "mx-auto mb-3 h-12 w-12 rounded-full bg-black/[0.03] flex items-center justify-center", children: _jsx("svg", { className: "h-6 w-6 text-black/20", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 1.5, children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" }) }) }), _jsx("p", { className: "text-sm font-medium text-black/40", children: message || "Nothing to display yet." })] }));
}
/* ------------------------------------------------------------------ */
/*  Timeline Layout                                                    */
/* ------------------------------------------------------------------ */
export default function TimelineLayout({ items, slug, detailEnabled, accent, loading, emptyMessage, LinkComponent, }) {
    ...
    return (_jsxs("div", { className: "relative pl-8 sm:pl-0", children: [_jsx("div", { className: "absolute left-3 sm:left-1/2 top-0 bottom-0 w-px", style: {
                    background: `color-mix(in srgb, ${primary} 15%, transparent)`,
                } }), _jsx("div", { className: "space-y-8 sm:space-y-12", children: items.map((item, i) => {
                    const isLeft = i % 2 === 0;
                    return (_jsxs("div", { className: "relative sm:grid sm:grid-cols-2 sm:gap-8", children: [_jsx("div", { className: "absolute left-3 sm:left-1/2 top-5 -translate-x-1/2 h-3.5 w-3.5 rounded-full ring-4 ring-white z-10 transition-transform duration-300 hover:scale-125", style: { background: primary } }), _jsx("div", { className: "hidden sm:block absolute top-[1.45rem] h-px w-8", style: {
                                    background: `color-mix(in srgb, ${primary} 15%, transparent)`,
                                    ...(isLeft
